...
connect_retry = 3                           # connect retry count
...
remote_command_timeout = 30.0               # timeout for command which is running in pty connections
...
delay_after_enter = 0.6                     # internal delay const
delay_after_intr = 0.2                      # internal delay const
delay_after_close = 0.5                     # internal delay const

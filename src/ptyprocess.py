...
from utils import which, PtyProcessError
...
class PtyProcess(object):
    ...
    def spawn(
        ...
        if use_native_pty_fork:
            ...
            # Use internal solaris_fork_pty, for Solaris
            pid, fd = solaris_fork_pty()
    ...
    def read_nonblocking(self, size=16):
